...
{      
    ...
    $password= $_POST['password'];  
        ...
        $sql = "SELECT * FROM registration WHERE username='$username' && password='$password'";  
         ...
         // echo "Favorite color is " . $_SESSION["email2"] . ".<br>"; 
         echo "<h1><center> Login successful </center></h1>";  
         echo ("<script LANGUAGE='JavaScript'>window.alert('Succesfully Updated');window.location.href='table2.php?flag=1';</script>");
